...
function filterLeaks(ok, globals) {
  return filter(globals, function(key){
    ...
    // in firefox
    // if runner runs in an iframe, this iframe's window.getInterface method not core at first
...
function highlight(js) {
  return js
    ...
    .replace(/\bnew *(\w+)/gm, '<span class="keyword">new</span> <span class="core">$1</span>')
